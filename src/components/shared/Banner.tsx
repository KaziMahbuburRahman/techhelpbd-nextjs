...
const Banner = () => {
  return (
    <div className="grid md:grid-cols-2 place-items-center bg-[#f1f5f9] my-5 p-8 gap-8">
    <div>
    ...
    <div className="">
      ...
      <p className="py-2">
        ...
        The New York Times. 
        <br /><br />
        OpenAI estimates that its revenue will balloon to
        copy1.6 billion next year. OpenAI revenue in August more than tripled
        from a year earlier, according to the documents, and about 350 million
        people — up from around 100 million in March of this year — used its
        services each month as of June.
      </p>
